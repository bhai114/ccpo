#!/usr/bin/env bash
# Two-model alternate training (Thinker + Solver), based on Olmo-3-7B-Instruct
...
experiment_name=olmo3-7b-instruct-math500-twomodel-peerRwd-$backend
...
# ============================================================================
: "${THINKER_MODEL_PATH:=/gz-data/models/Olmo-3-7B-Instruct}"
: "${SOLVER_MODEL_PATH:=/gz-data/models/Olmo-3-7B-Instruct}"
...
VAL_VIEW_DIR=$DATA_ROOT/data/val_metric_views/olmo3_7b_gspo_twomodel
