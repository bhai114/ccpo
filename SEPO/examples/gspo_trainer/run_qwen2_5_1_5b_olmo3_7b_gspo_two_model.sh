#!/usr/bin/env bash
# Two-model alternate training (Thinker + Solver), based on Qwen2.5-1.5B-Instruct + Olmo-3-7B-Instruct
...
experiment_name=qwen2.5-1.5b-olmo3-7b-instruct-math500-twomodel-peerRwd-$backend
...
VAL_VIEW_DIR=$DATA_ROOT/data/val_metric_views/qwen2_5_1_5b_olmo3_7b_gspo_twomodel
