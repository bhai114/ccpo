#!/usr/bin/env bash
# Two-model alternate training (Thinker + Solver), based on Qwen2.5-1.5B-Instruct
...
experiment_name=qwen2.5-1.5b-instruct-math500-twomodel-peerRwd-$backend
...
VAL_VIEW_DIR=$DATA_ROOT/data/val_metric_views/qwen2_5_1_5b_gspo_twomodel
