#!/usr/bin/env bash
# Two-model alternate training (Thinker + Solver), based on Qwen3-4B-Base
...
#
# This script mirrors the base GSPO recipe and only diverges where the
# two-model recipe requires.
...
RUN_ROOT=${RUN_ROOT:-/gz-data/ccpo-verl-mulitAgent-peerRwd}
cd "$RUN_ROOT"
...
experiment_name=qwen3-4b-base-math500-twomodel-peerRwd-$backend
...
# ============================================================================
: "${THINKER_MODEL_PATH:=/gz-data/models/Qwen3-4B-Base}"
: "${SOLVER_MODEL_PATH:=/gz-data/models/Qwen3-4B-Base}"
...
# Data / Model
# ============================================================================
train_files=/gz-data/ccpo-verl-mulitAgent-peerRwd/data/MATH/train.parquet
VAL_VIEW_DIR=$DATA_ROOT/data/val_metric_views/qwen3_4b_base_gspo_twomodel
...
val_sets = [
    ("math500", "/gz-data/ccpo-verl-mulitAgent-peerRwd/data/MATH/test500.parquet"),
    ("aime2024", "/gz-data/ccpo-verl-mulitAgent-peerRwd/data/aime2024_fixed_with_prompt.parquet"),
    ("aime2025", "/gz-data/ccpo-verl-mulitAgent-peerRwd/data/aime2025_fixed_with_prompt.parquet"),
    ("amc23", "/gz-data/ccpo-verl-mulitAgent-peerRwd/data/amc23_fixed_with_prompt.parquet"),
    ("gaokao2023", "/gz-data/ccpo-verl-mulitAgent-peerRwd/data/Gaokao2023-Math-En_with_prompt.parquet"),
    ("minervamath", "/gz-data/ccpo-verl-mulitAgent-peerRwd/data/MinervaMath_with_prompt.parquet"),
]
