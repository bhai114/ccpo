#!/usr/bin/env bash
# Two-model alternate training (Thinker + Solver) with GRPO and the
# Counterfactuals branch reward, based on two Qwen2.5-1.5B-Instruct models.
#
...
# keeping the counterfactual joint/solo reward plumbing.
...
# The Counterfactuals two-model recipe lives under gspo_trainer, but it is
...
experiment_name=qwen2.5-1.5b-instruct-math500-twomodel-grpo-confact-$backend
default_local_dir=$DATA_ROOT/checkpoint/$project_name/$experiment_name

# ============================================================================
# Two-model / counterfactual knobs
# ============================================================================
...
VAL_VIEW_DIR=$DATA_ROOT/data/val_metric_views/qwen2_5_1_5b_grpo_twomodel_confact
